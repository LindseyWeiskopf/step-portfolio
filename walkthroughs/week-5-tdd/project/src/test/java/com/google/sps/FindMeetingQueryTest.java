...
public final class FindMeetingQueryTest {
  ...
  private static final String PERSON_C_OPTIONAL = "OPTIONAL Person C";
  private static final String PERSON_D_OPTIONAL = "OPTIONAL Person D";
  ...
  public void optionalAttendeeConsidered() {
    // based on everyAttendeeIsConsidered, add an optional attendee C who has an event 
  ...
  public void optionalAttendeesOnlyWithRoom() {
    ...
    Collection<Event> events = Arrays.asList(
      ...
      new Event("Event 2", TimeRange.fromStartDuration(TIME_1000AM, DURATION_60_MINUTES),
          Arrays.asList(PERSON_D_OPTIONAL)));

    MeetingRequest request = new MeetingRequest(NO_ATTENDEES, DURATION_1_HOUR);
    request.addOptionalAttendee(PERSON_C_OPTIONAL);
    request.addOptionalAttendee(PERSON_D_OPTIONAL);
